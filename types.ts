...
/**
 * Cached simulation result entry for a single skill.
 * The rawResults can be used to recalculate stats with different discounts.
 */
...
/**
 * Configuration values that affect simulation results (used for cache key).
 */
export interface SimulationConfigForHash {
    courseIds: string[]
